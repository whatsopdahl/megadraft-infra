locals {
  # Dev also allows the local Vite dev server, matching the Google OAuth
  # "Authorized JavaScript origins" convention documented in the README.
  cors_allow_origins = ["https://${var.subdomain}.${var.root_domain}", "http://localhost:5173"]
}
